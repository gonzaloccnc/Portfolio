...
const Proyect: React.FC<ProyectProps> = ({ title, des, github, web, img }) => {
  return (
    <div id='proyect' className={`mini:w-32 lg:w-72 mini:h-32 lg:h-72 cursor-pointer ${img} bg-cover bg-no-repeat rounded-xl`}>
      <div
        ...
        <p className='mini:text-[8px] lg:text-base text-center mini:w.w-full lg:w-3/4 mx-auto'>{des}</p>
